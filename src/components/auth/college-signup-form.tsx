...
const collegeSignupSchema = z
  .object({
    ...
    email: z
      ...
      .refine((email) => email.endsWith('.edu'), 'Only .edu email addresses are allowed for college representatives.'),
  ...
  return (
    <Card className="w-full max-w-md shadow-lg">
      <CardHeader>
        ...
        <CardDescription>Create an account to manage your college's profile on CampusConnect. You must use a valid .edu email address.</CardDescription>
      </CardHeader>
      <Form {...form}>
